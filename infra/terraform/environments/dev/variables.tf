...
variable "aws_profile" {
  type        = string
  description = "AWS CLI / SSO profile for the trustlist-dev account."
  default     = "trustlist-dev"
}

variable "account_id" {
  type        = string
  description = "The 12-digit trustlist-dev account ID — keeps S3 bucket names globally unique."
}
